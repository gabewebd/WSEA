...
<head>
    ...
    <style>
        * {
        ...
        body {
            /* 60% Black Overlay on top of login-bg.webp */
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('../assets/img/danonos-hero.webp');
...
<body>
    ...
    <div class="login-card">
        <img src="../assets/img/danonos-logo.webp" alt="Danonos"
