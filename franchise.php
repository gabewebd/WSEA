<!DOCTYPE html>
<html>
<head><title>Franchise</title><link rel="stylesheet" href="style.css"></head>
<body>
    ...
    <div class="container">
        ...
        <div style="background:white; padding:40px; border-radius:15px; max-width:600px; margin:0 auto;">
            ...
            <form>
                ...
                <input type="email" placeholder="Email Address" style="width:100%; padding:10px; margin-bottom:10px;"><br>
                <input type="text" placeholder="Proposed Location" style="width:100%; padding:10px; margin-bottom:10px;"><br>
