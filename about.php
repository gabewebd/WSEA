...
<section class="about-hero">
    ...
    <div class="about-hero-content">
        ...
        <h1 data-aos="fade-up" data-aos-delay="100">Spreading Happiness,<br>One <span class="pop-out-text">DOUGHNUT</span> at a Time.</h1>
    </div>
...
<section class="story-section">
    <div class="story-content">
        ...
        <div class="story-text" data-aos="fade-left">
            ...
            <p>Using our signature brioche dough recipe—rich, fluffy, and buttery—we spent months perfecting the balance of texture and flavor. Today, Danono's is more than just a bakery; it's a place where friends gather.</p>
...
<section class="gallery-section">
    <div class="gallery-text" data-aos="fade-right">
        ...
        <a href="menu.php" class="btn btn-orange btn-shine" style="margin-top: 20px;">Order Now</a>
    </div>
...
<section class="about-cta">
    <div class="cta-content" data-aos="zoom-in-up">
        ...
        <div class="cta-buttons">
            <a href="menu.php" class="btn btn-orange btn-shine">View Menu</a>
